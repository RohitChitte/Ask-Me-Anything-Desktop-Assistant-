...
class MongoDBManagement:
    ...
    def __init__(self, username, password):
        ...
        try:
            ...
            #self.url = "mongodb+srv://{}:{}@cluster0.bul1l.mongodb.net/myFirstDatabase?retryWrites=true&w=majority".format(
            #   self.username, self.password)
            #mongodb+srv://<username>:<password>@cluster0.bul1l.mongodb.net/myFirstDatabase?retryWrites=true&w=majority
            # self.url = 'localhost:27017'
            self.url = f"mongodb+srv://{self.username}:{self.password}@cluster1.0gfqm.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
...
obg = MongoDBManagement("test","test")
client = obg.getMongoDBClientObject()
